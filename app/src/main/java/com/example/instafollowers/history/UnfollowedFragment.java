...
public class UnfollowedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getUnollowedUsernames();

        UsersAdapter adapter = new UsersAdapter(mainActivity);

        viewModel.getUnfollowedUsernames().observe(
        ...
        request.enqueue(new Callback<UsersResponse>() {
            ...
            public void onResponse(Call<UsersResponse> call, Response<UsersResponse> response) {
                ...
                if(response.code() == 500){
                    ...
                    viewModel.setUnfollowedUsernames(list);
                }
